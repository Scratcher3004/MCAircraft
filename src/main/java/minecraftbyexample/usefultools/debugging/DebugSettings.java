...
public class DebugSettings {
  ...
  public static synchronized void setDebugParameterVec3d(String parameterName, Vec3 value) {
    debugParameterVec3ds.put(parameterName, Optional.of(new Vector3d(value.x, value.y, value.z)));
  }
