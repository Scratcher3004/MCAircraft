...
public class DataLogger {
  ...
  static private PrintStream getOrCreate(String datalogName) throws FileNotFoundException {
    if (!dataLogs.containsKey(datalogName)) {
      MinecraftServer minecraftServer = LogicalSidedProvider.CLIENTWORLD.get(LogicalSide.SERVER).get().getServer();
      File dataDirectory = minecraftServer.getServerDirectory();
