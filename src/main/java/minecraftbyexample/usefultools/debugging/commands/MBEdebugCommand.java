...
public class MBEdebugCommand {
  public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
    ...
    LiteralArgumentBuilder<CommandSourceStack> mbedebugCommand
      = Commands.literal("mbedebug")
            .then(Commands.literal("param")
                    .then(Commands.argument("parametername", StringArgumentType.word())
                            /* TODO .suggests((context, builder) ->
                                    SuggestionProviders.register(DebugSettings.listAllDebugParameters().stream(), builder))*/
