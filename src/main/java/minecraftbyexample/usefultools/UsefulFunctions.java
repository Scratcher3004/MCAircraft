...
public class UsefulFunctions
{
   ...
   */
  public static ListTag serializeVec3d(Vec3 vec3d) {
   ...
   */
  public static Vec3 deserializeVec3d(CompoundTag nbt, String tagname) {
    ListTag listnbt = nbt.getList(tagname, NBTtypesMBE.DOUBLE_NBT_ID);
    Vec3 retval = new Vec3(listnbt.getDouble(0), listnbt.getDouble(1), listnbt.getDouble(2));
    return retval;
  }
}
